<template>
  ...
  >
    <div class="space-y-3">
      <p class="text-white text-lg">New Connection</p>
      ...
      <div class="grid grid-cols-12 gap-3">
        <button
          ...
          class="data-[active=true]:bg-primary data-[active=true]:bg-opacity-20 hover:data-[active=true]:bg-opacity-30 data-[active-true]:text-white relative col-span-2 aspect-square border border-line hover:bg-line rounded"
        ...
        >
          ...
          <div class="absolute right-0 bottom-0 left-0 h-6">
            <p class="text-center text-xs text-body">Databricks</p>
          </div>
        </button>
      </div>
